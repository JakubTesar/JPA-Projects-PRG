...
public class TaskBean {
    ...
    public List<TaskEntity> getBacklogs() {
        ...
        TypedQuery<TaskEntity> query = em.createQuery(
                "SELECT task " +
                        ...
                        "WHERE task.status = kanban.Status.Backlog", TaskEntity.class);
    ...
    public List<TaskEntity> getInProgress() {
        ...
        TypedQuery<TaskEntity> query = em.createQuery(
                "SELECT task " +
                        "FROM TaskEntity AS task " +
                        "WHERE task.status =  kanban.Status.InProgress", TaskEntity.class);
        List<TaskEntity> result = query.getResultList();
    ...
    public List<TaskEntity> getInReview() {
        ...
        TypedQuery<TaskEntity> query = em.createQuery(
                "SELECT task " +
                        "FROM TaskEntity AS task " +
                        "WHERE task.status =  kanban.Status.InReview", TaskEntity.class);
        List<TaskEntity> result = query.getResultList();
    ...
    public List<TaskEntity> getTest() {
        ...
        TypedQuery<TaskEntity> query = em.createQuery(
                "SELECT task " +
                        "FROM TaskEntity AS task " +
                        "WHERE task.status =  kanban.Status.Test", TaskEntity.class);
        List<TaskEntity> result = query.getResultList();
    ...
    public List<TaskEntity> getFinished() {
        ...
        TypedQuery<TaskEntity> query = em.createQuery(
                "SELECT task " +
                        "FROM TaskEntity AS task " +
                        "WHERE task.status =  kanban.Status.Finished", TaskEntity.class);
        List<TaskEntity> result = query.getResultList();
